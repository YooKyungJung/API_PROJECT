...
function handleRefresh() {
	...
	{
	var j = i + 999;
    var url="http://openapi.seoul.go.kr:8088/4a5243534579756736356f4a4c6d41/json/MgisHealingPlace/"+i+"/"+j;
...
function updateLibrary(librarys) {//16번 호출
   var librarys = librarys.MgisHealingPlace.row;
   var addr = "";
   ...
   var librarysDiv = document.getElementById("librarys");
	...
	for(var i=0; i<librarys.length; i++){
		...
		if (lib.COT_GU_NAME == gus) {
			...
			if (lib.COT_ADDR_FULL_OLD != "") {
				div.innerHTML += "<br>" + "주소: " + lib.COT_ADDR_FULL_OLD + "(x:"
						+ lib.COT_COORD_Y + "&nbsp;,&nbsp;y:" + lib.COT_COORD_X + ")";
			}
			
			if (lib.COT_VALUE_03 != "") {
				div.innerHTML += "<br>이용정보: " + lib.COT_VALUE_03;
			}
			
			if (lib.COT_VALUE_04 != "") {
				div.innerHTML += "<br>주차시설: " + lib.COT_VALUE_04;
			}
			
			if (lib.COT_VALUE_05 != "") {
				div.innerHTML += "<br>찾아가는 방법) " + lib.COT_VALUE_05;
			}
			if (lib.COT_VALUE_08 != "") {
				div.innerHTML += "<br>"+ lib.COT_NAME_08+": " + lib.COT_VALUE_08;
			}
...
function addBound(){
	...
	var bound = new daum.maps.Circle({
	   ...
	   strokeColor: '#353866', // 선의 색깔입니다
	   strokeOpacity: 0.5, // 선의 불투명도 입니다 1에서 0 사이의 값이며 0에 가까울수록 투명합니다
	   strokeStyle: 'solid', // 선의 스타일 입니다
	   fillColor: '#353866', // 채우기 색깔입니다
