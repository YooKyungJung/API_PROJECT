...
function handleRefresh() {
	...
	{
	var j = i + 999;
    var url="http://openapi.seoul.go.kr:8088/4a5243534579756736356f4a4c6d41/json/MgisHollowRoad/"+i+"/"+j;
...
function updateLibrary(librarys) {//16번 호출
   var librarys = librarys.MgisHollowRoad.row;
   var addr = "";
   ...
   var librarysDiv = document.getElementById("librarys");
	...
	for(var i=0; i<librarys.length; i++){
		...
		if (lib.COT_GU_NAME == gus) {
			div.innerHTML = lib.COT_CONTS_NAME;
			...
			if (lib.COT_VALUE_02 != "") {
				div.innerHTML += "<br>소개: " + lib.COT_VALUE_02;
			}
			
			if (lib.COT_VALUE_01 != "") {
				div.innerHTML += "<br>" + "거리 및 소요시간: " + lib.COT_VALUE_01;
			}
			
			
			if (lib.COT_VALUE_03 != "") {
				div.innerHTML += "<br>교통편) " + lib.COT_VALUE_03;
			}
			
			if (lib.COT_VALUE_04 != "") {
				div.innerHTML += "<br>세부코스: " + lib.COT_VALUE_04;
			}
...
function addBound(){
	...
	var bound = new daum.maps.Circle({
	   ...
	   strokeColor: '#77AAAD', // 선의 색깔입니다
	   strokeOpacity: 0.5, // 선의 불투명도 입니다 1에서 0 사이의 값이며 0에 가까울수록 투명합니다
	   strokeStyle: 'solid', // 선의 스타일 입니다
	   fillColor: '#77AAAD', // 채우기 색깔입니다
...
function addMarker(imageSrc, imageSize, imageOption, latitude, longitude, name, address,tel, closeday) {
	...
	var content =  "<div style='width:100%; height:100%; padding:5px; font-size:0.8em;'>"+'<b>'+ name +'</b>'+'<br>'+"주소 : " +address+'<br>'+tel+'<br>'+"교통편 ) " +closeday+" </div>";
